...
<template>
  <section class="">
    <div class="text-lg h-[calc(100vh_-_68px)] overflow-hidden">
          ...
          <div class="h-full w-full">
            <div class="overflow-y-auto min-h-screen px-12">
              <div class="py-6 text-center">
                ...
                <p class="">
                  View and Update your account details and profiles.
                </p>
              </div>
              <div
              ...
              >
                ...
                <div class="">
                  ...
                  <div class="flex items-center py-3 border-b-2">
                    ...
                    <div class="w-full">{{ useAuth.userData.displayName }}</div>
                    <div class="">
