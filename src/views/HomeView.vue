...
<template>
  <MainLayout>
    <div class="min-h-screen">
      <div class="w-full bg-white py-5 px-6">
        <div
        ...
        >
          <div class="mt-6 lg:mt-0">
            ...
            >
              ...
              <span
                class="text-primary-color text-3xlfont-extrabold inline-block"
                >.</span
              >
            </h2>
            <p
            ...
            >
              ...
              partners. You can use the generator to make email signatures that
