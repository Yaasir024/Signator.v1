...
<template>
  <div class="">
    <button
      ...
      :class="useTemplateStore.currentEditorTab == 'details' ? 'bg-white' : ''"
      @click="useTemplateStore.currentEditorTab = 'details'"
    >
      <svg
        width="24"
        height="24"
    ...
    <button
      class="flex flex-col items-center justify-center h-[74px] w-full px-1 hover:text-gray-500 transition-all ease-in-out duration-400"
      :class="useTemplateStore.currentEditorTab == 'images' ? 'bg-white' : ''"
      @click="useTemplateStore.currentEditorTab = 'images'"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
    ...
    <button
      class="flex flex-col items-center justify-center h-[74px] w-full px-1 hover:text-gray-500 transition-all ease-in-out duration-400"
      :class="useTemplateStore.currentEditorTab == 'social' ? 'bg-white' : ''"
      @click="useTemplateStore.currentEditorTab = 'social'"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
    ...
    <button
      class="flex flex-col items-center justify-center h-[74px] w-full px-1 hover:text-gray-500 transition-all ease-in-out duration-400"
      :class="useTemplateStore.currentEditorTab == 'design' ? 'bg-white' : ''"
      @click="useTemplateStore.currentEditorTab = 'design'"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 256 256"
      ...
      >
        ...
        <path
          ...
          stroke-width="16"
        ></path>
        <circle cx="128" cy="76" r="16"></circle>
        <circle cx="83" cy="102" r="16"></circle>
        <circle cx="83" cy="154" r="16"></circle>
        <circle cx="173" cy="102" r="16"></circle>
      </svg>
      <span>Design</span>
    </button>
  </div>
