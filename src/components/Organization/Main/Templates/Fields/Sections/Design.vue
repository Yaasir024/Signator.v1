...
<template>
  <div class="">
    ...
    <div class="py-5 px-10">
      <div class="">
        <div class="text-base font-medium uppercase mb-2">Layout</div>
        <!-- Font Family -->
      ...
      <div class="image mt-10 pb-4 border-b">
        <div class="text-base font-medium uppercase mb-2">Image</div>
        <!-- Image Width -->
        <div class="mb-5">
          <div class="flex items-center justify-between">
      ...
      <div class="social-icon mt-8 pb-4 border-b">
        <div class="text-base font-medium uppercase mb-2">Details</div>
        <!-- Label -->
        <div class="flex items-center mb-5">
      ...
      <div class="social-icon mt-8 pb-6">
        <div class="mb-2">
          <div class="text-base font-medium uppercase mb-2">Social Icon</div>
        </div>
