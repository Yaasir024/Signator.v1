...
import Links from "@/components/Organization/Sidebar/Links.vue";
...
<template>
  <aside class="sidebar static top-0 h-screen">
    <div
      class="w-[230px] bg-canvas-color shadow-xl border-r h-full flex flex-col overflow-hidden"
    >
      <div
        class="px-5 py-4 border-b flex items-center justify-between cursor-pointer"
      >
        <div class="flex items-center w-[175px]">
          <img src="/organization/logo.png" alt="" class="h-[40px]" />
          <span
            class="text-base whitespace-nowrap overflow-hidden overflow-ellipsis"
          >
            CodeCraft Institute Of Technology</span
          >
        </div>
        <div class="">
          <svg
      ...
      <div class="px-5 mt-12">
        <div class="pb-2 border-b-2">
          <Links text="Employees" @click="useDashboardStore.currentSection = 'employees'">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              class="w-[18px] h-[18px]"
          ...
          <Links text="Templates" @click="useDashboardStore.currentSection = 'templates'">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <Links text="Groups" @click="useDashboardStore.currentSection = 'groups'">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <Links text="Company Details" @click="useDashboardStore.currentSection = 'companyDetails'">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              class="w-[18px] h-[18px]"
...
<style scoped>
button.active {
  background: linear-gradient(92deg, rgb(135 206 235) -229%, transparent 94%);
}
</style>
