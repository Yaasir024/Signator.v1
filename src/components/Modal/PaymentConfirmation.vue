...
<template>
  ...
  >
  {{ usePayment.customerDetail }}
      <div class="absolute top-3 right-3 cursor-pointer z-30" @click="usePayment.paymentConfirmationModal = false">
        <svg
