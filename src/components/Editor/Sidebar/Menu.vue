...
const setNavValue = (value) => {
  useEditorStore.currentEditorNav = value;
};
</script>
  ...
  <div class="left h-full bg-canvas-color max-w-[74px] w-full">
    <div class="w-full">
      ...
      <button
        ...
        :class="useEditorStore.currentEditorNav === 'general' ? 'bg-white' : ''"
      ...
      <button
        class="flex flex-col items-center justify-center h-[74px] w-full px-1 hover:text-gray-500 transition-all ease-in-out duration-400"
        :class="useEditorStore.currentEditorNav === 'social' ? 'bg-white' : ''"
      ...
      <button
        class="flex flex-col items-center justify-center h-[74px] w-full px-1 hover:text-gray-500 transition-all ease-in-out duration-400"
        :class="useEditorStore.currentEditorNav === 'addons' ? 'bg-white' : ''"
      ...
      <button
        class="flex flex-col items-center justify-center h-[74px] w-full px-1 hover:text-gray-500 transition-all ease-in-out duration-400"
        :class="useEditorStore.currentEditorNav === 'design' ? 'bg-white' : ''"
